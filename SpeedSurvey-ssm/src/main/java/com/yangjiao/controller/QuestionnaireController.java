...
public class QuestionnaireController {
    ...
    @PostMapping("/add")
    @ResponseBody
    public Map<String,Object> doAdd(@RequestBody  Map<String,Object> questionnaireMap){
        ...
        Boolean ipRestrict =(Integer)questionnaireMap.get("ipRestrict");
        Integer org = (Integer)questionnaireMap.get("org");
        Questionnaire questionnaire = new Questionnaire();
        questionnaire.setTitle(title);
        questionnaire.setDescription(desc);
        questionnaire.setIpLimit(ipRestrict);
