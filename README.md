...
| 接口地址              | HTTP方法 | 传入参数 | 返回参数类型 | 功能                     |
| --------------------- | -------- | -------- | ------------ | ------------------------ |
| /api/text_result/list | GET      | 见下表   | json         | 获取某一填空题所有的答案 |
...
| 接口地址                  | HTTP方法 | 传入参数 | 返回参数类型 | 功能         |
| ------------------------- | -------- | -------- | ------------ | ------------ |
| /api/questionnaire/delete | GET      | wjId     | json         | 删除某一问卷 |
...
| 接口地址                | HTTP方法 | 传入参数    | 返回参数类型 | 功能              |
| ----------------------- | -------- | ----------- | ------------ | ----------------- |
| /api/questionnaire/push | POST     | wjId,status | json         | 发布问卷/暂停问卷 |
...
| ---------------------- | -------- | ------------ | ------------ | -------------- |
| /api/questionnaire/add | POST     | json         | json         | 创建或更新问卷 |
...
| 接口地址             | HTTP方法 | 传入参数 | 返回参数类型 | 功能                 |
| -------------------- | -------- | -------- | ------------ | -------------------- |
| /api/question/delete | GET      | id       | json         | 删除问卷中的一个问题 |
...
| 接口地址          | HTTP方法 | 传入参数类型 | 返回参数类型 | 功能               |
| ----------------- | -------- | ------------ | ------------ | ------------------ |
| /api/question/add | POST     | json         | json         | 添加或更新某一问题 |
